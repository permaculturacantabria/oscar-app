...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-primary:hover { background: #e55a15; transform: translateY(-1px); }
        .btn-success { background: #48bb78; color: white; }
        .btn-warning { background: #ff8c42; color: white; }
        ...
        .badge-warning { background: #ffeaa7; color: #744210; }
        .badge-danger { background: #fed7d7; color: #742a2a; }
        .badge-info { background: #ddd6fe; color: #2a4365; }
            ...
            <div class="stats-grid">
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon" style="background: #ff6b1a;">
                ...
                <div class="stat-card">
                    <div class="stat-header">
                        ...
                        <div class="stat-icon" style="background: #ff8c42;">
