...
<main style="max-width:420px;margin:40px auto;padding:20px;border:1px solid #ddd;border-radius:8px;">
    ...
    <form method="POST" action="/register">
        @csrf
        <label>Nombre</label>
        <input name="name" type="text" value="{{ old('name') }}" required style="width:100%;margin:6px 0 12px;">
        ...
        <button type="submit" class="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded">Registrarme</button>
    </form>
